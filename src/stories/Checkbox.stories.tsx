...
export const Sizes = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "16px", alignItems: "flex-start" }}>
      <Checkbox size="sm" label="Small 체크박스" onChange={action("small-change")} />
      <Checkbox size="md" label="Medium 체크박스" onChange={action("medium-change")} />
      <Checkbox size="lg" label="Large 체크박스" onChange={action("large-change")} />
    </div>
  ),
  parameters: {
    docs: {
...
export const Colors = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "12px", alignItems: "flex-start" }}>
      <Checkbox color="primary" label="Primary" defaultChecked onChange={action("primary-change")} />
      <Checkbox color="secondary" label="Secondary" defaultChecked onChange={action("secondary-change")} />
      <Checkbox color="success" label="Success" defaultChecked onChange={action("success-change")} />
      <Checkbox color="error" label="Error" defaultChecked onChange={action("error-change")} />
      <Checkbox color="warning" label="Warning" defaultChecked onChange={action("warning-change")} />
      <Checkbox color="info" label="Info" defaultChecked onChange={action("info-change")} />
    </div>
  ),
  parameters: {
    docs: {
...
export const States = {
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: "12px", alignItems: "flex-start" }}>
      ...
      <Checkbox label="체크됨" defaultChecked onChange={action("checked-change")} />
      <Checkbox label="비활성화" disabled onChange={action("disabled-change")} />
      <Checkbox label="비활성화 + 체크됨" disabled defaultChecked onChange={action("disabled-checked-change")} />
      <Checkbox label="중간 상태" indeterminate onChange={action("indeterminate-change")} />
      <Checkbox label="필수 항목" required onChange={action("required-change")} />
    </div>
  ),
  parameters: {
    docs: {
