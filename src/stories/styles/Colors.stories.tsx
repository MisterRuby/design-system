...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "프로젝트에서 사용하는 색상 시스템입니다. 일관된 디자인을 위해 정의된 색상을 사용해주세요.",
      },
    },
  },
};
...
export const GrayScale = {
  ...
  parameters: {
    docs: {
      source: {
        code: `import { colors, semanticBorders } from "../../tokens";
          ...
          {Object.entries(colors.border.focus).map(([variant, color]) => (
            <div key={variant} style={{ textAlign: "center" }}>
              <div
                ...
                <span
                  style={{ fontSize: fontSize.xs, color: colors.gray[600] }}>
                  Focus
                </span>
              </div>
              <div
          ...
          {Object.entries(colors.focusRing).map(([type, color]) => (
            <button
              ...
              style={{
                padding: "8px 16px",
                border: `2px solid ${
                  colors.border[type as keyof typeof colors.border] ||
