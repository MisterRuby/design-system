...
export default {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "웹사이트나 앱의 상단 헤더 컴포넌트입니다. 로고, 네비게이션, 액션 버튼 등을 포함할 수 있습니다.",
      },
    },
  },
  tags: ["autodocs"],
...
export const StickyHeader = {
  args: {
    ...
    actions: (
      <Button
        variant="primary"
        size="small"
        onClick={action("get-started-clicked")}>
        Get Started
      </Button>
    ),
    variant: "default",
  ...
  parameters: {
    docs: {
      description: {
        story:
          "스크롤 시 상단에 고정되는 헤더입니다. 긴 페이지에서 항상 네비게이션에 접근할 수 있습니다.",
      },
    },
  },
};
  ...
  render: () => (
    <div style={{ display: "flex", flexDirection: "column", gap: spacing.md }}>
      <Header
        title="Small Header"
        height="small"
        navigation={[{ label: "Menu 1" }, { label: "Menu 2" }]}
