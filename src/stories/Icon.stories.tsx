...
export default {
  ...
  argTypes: {
    name: {
      control: 'select',
      options: [
        'search', 'eye', 'eye-off', 'arrow-right', 'arrow-left', 'arrow-down', 'arrow-up',
        'close', 'check', 'plus', 'minus', 'edit', 'delete', 'calendar', 'clock',
        'user', 'settings', 'menu', 'home', 'mail', 'phone', 'lock', 'unlock',
        'star', 'star-filled', 'heart', 'heart-filled', 'bookmark', 'share',
        'download', 'upload', 'refresh', 'info', 'warning', 'error', 'success'
      ],
